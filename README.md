...
The system will install WSL2, set it as default version and chose ubuntu in windows appstore. Instructions [click here](https://docs.microsoft.com/en-us/windows/wsl/install-win10#step-4---download-the-linux-kernel-update-package)
